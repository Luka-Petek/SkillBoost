      ...
      <main id="top">
        <section className="hero-grid">
          <div className="hero-card">
            ...
            <p>
              This version keeps the LLM part simulated with MongoDB prompt JSON,
              so the app can be demo-ready without external AI integration.
            </p>
            ...
            <section className="workspace-grid">
              ...
              <aside className="panel side-panel">
                ...
                <form className="stack" onSubmit={handleCreateUser}>
                  ...
                  <button className="secondary" disabled={saving}>Create user</button>
                </form>
              </aside>
            </section>
          </>
  ...
  return (
    <div className="content-section">
      ...
      <form className="simulation-form" onSubmit={handleSubmitSession}>
        ...
        <button className="primary" disabled={saving}>{saving ? 'Saving...' : 'Submit simulation'}</button>
      </form>
        ...
        <div className="feedback-card">
          ...
          <div>
            ...
            <div className="mentor-row">
              ...
              <button className="secondary" type="button" onClick={handleMentorNote}>Save note</button>
            </div>
          </div>
        </div>
      )}
...
function PromptsSection({ filteredPrompts, newPrompt, setNewPrompt, handleCreatePrompt, selectedSkillKey, saving }) {
  return (
    <div className="content-section">
      <div className="section-title">
      ...
      <div className="prompt-layout">
        ...
        <form className="prompt-form" onSubmit={handleCreatePrompt}>
          ...
          <button className="primary" disabled={saving}>Save prompt</button>
        </form>
      </div>
    </div>
  );
